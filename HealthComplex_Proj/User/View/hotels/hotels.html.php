...
<head>
    <meta charset="UTF-8">
    <title>Health Complex|Hotels</title>
...
<div class="bodyContainer">
    ...
    <div class="citiesListContainer">
        <div class="citiesHeader">Available Hotels</div>
        <div class="row">
            <div class="col-12">
    ...
    <div class="cardsContainer" style="align-content: center;">
        ...
        <div class=" verdana">
            <div class="tab-content cityHeader titleContainer" id="nav-tabContent" style="text-align: center; width: 100%; position: center;">
                <div class="tab-pane fade show active cityHeader" id="list-all" role="tabpanel" aria-labelledby="list-all-list"><?php echo strtoupper($city)." 'S " ?>TOP HOTELS</div>
            ...
            <div class="detailContainer">Featured and well-known hotels <br>– they are the mostly trusted by tourists.</div>
                        ...
                        foreach($rows as $row)
                        {
                            if(isset($row) and count($row))
                            {
                                if($city == "all")
                                {
                                    ...
                                    $query = "SELECT filename FROM $hotelImageTable LIMIT 1";
                                    $s = $pdo ->prepare($query);
                                    $s -> execute();
                                    $img = $s -> fetch();
                                    if($img)
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-2">
                                            <img class="card-img-top tourismDestinationImages" src="../../../images/<?php echo $hotelImageTable; ?>/<?php if(isset($img_name)){echo $img_name;} ?>"
                                                 alt="Card image cap">
                                            <div class="card-body">
                                                <h4 class="card-title"><?php echo $name." " ?> Hotel</h4>
                                                <p class="card-text toursitDesctiption"><?php echo $comment?></p>
                                                <form method="post" action="../hotel_single/index.php">
                                                    <input type="hidden" name="name" value="<?php echo $name?>">
                                                    <input type="hidden" name="city" value="<?php echo $row['city'];?>">
                                                    <input type="submit" name="singleHotel" value="see more" class="btn btn-primary">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
